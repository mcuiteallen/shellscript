...
function httpdinstall {
	...
	cd /home/"$httpd"/systembuild/
	sudo unzip /home/"$httpd"/systembuild/ssl_key.zip
	sudo mv /etc/httpd/conf/httpd.conf /etc/httpd/conf/httpd_bk.conf
	sudo mv /home/"$httpd"/systembuild/ssl_key/httpd.conf /etc/httpd/conf/
	sudo mv /home/"$httpd"/systembuild/ssl_key/Insynerger.key /etc/httpd/conf/
	sudo mv /home/"$httpd"/systembuild/ssl_key/74b55e8e141f69b7.crt /etc/httpd/conf/
	sudo mv /home/"$httpd"/systembuild/ssl_key/gd_bundle-g2-g1.crt /etc/httpd/conf/
	sudo mv /home/"$httpd"/systembuild/ssl_key/mod_jk.so /etc/httpd/modules
